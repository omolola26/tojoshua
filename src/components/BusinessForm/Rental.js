					...
					<div className="inputDetails">
						<div className="newDrop">
							...
							<div className="radioField">
								<input type="radio" value="Male" name="gender" className="rad" />
								<label>Male</label>
								<input type="radio" value="female" name="gender" className="rad" />
								<label>Female</label>
								<input type="radio" value="not to say" name="gender" className="rad" />
						...
						<div className="newDrop">
							<div className="field">
								<input
									...
									id="formBasicmail"
								/>
								{/* <img src={Vector} className="card-img-top" alt="image" /> */}
								<div className="minus">-</div>
							</div>
							<div className="field">
								<input
							...
							<div className="field">
								<select className="inputDropDown">
									<option Value="Car Type" id="CarBrand" defaultValue="Car Type">Car Type</option>
